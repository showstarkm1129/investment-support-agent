...
- `evidence.json`: must satisfy `contracts/evidence.schema.json`.
- `agent_outputs.json`: must satisfy `contracts/agent_output.schema.json`.
- `report_judge.json`: must satisfy `contracts/report_judge.schema.json`.
- `chat_judge.json`: must satisfy `contracts/chat_judge.schema.json`.
- `health.json`: must satisfy `contracts/health.schema.json`.
